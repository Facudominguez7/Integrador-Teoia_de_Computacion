...
_lr_productions = [
  ...
  ('statements -> statements statement','statements',2,'p_declaraciones_multiples','ansintactico.py',31),
  ('statements -> statement','statements',1,'p_declaraciones_unica','ansintactico.py',35),
  ('statement -> ID ASSIGN expression SEMICOLON','statement',4,'p_declaracion_asignacion','ansintactico.py',39),
  ('expression -> expression PLUS term','expression',3,'p_expresion_operacion_binaria','ansintactico.py',43),
  ('expression -> expression MINUS term','expression',3,'p_expresion_operacion_binaria','ansintactico.py',44),
  ('expression -> term','expression',1,'p_expresion_termino','ansintactico.py',48),
  ('term -> term TIMES factor','term',3,'p_termino_operacion_binaria','ansintactico.py',52),
  ('term -> term DIVIDE factor','term',3,'p_termino_operacion_binaria','ansintactico.py',53),
  ('term -> factor','term',1,'p_termino_factor','ansintactico.py',57),
  ('factor -> NUMBER','factor',1,'p_factor_numero','ansintactico.py',61),
  ('factor -> ID','factor',1,'p_factor_id','ansintactico.py',65),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expresion','ansintactico.py',69),
]
